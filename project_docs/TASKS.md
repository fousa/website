...
- [ ] **1.1 Init Project**: Setup Next.js (App Router, TS, Tailwind). Remove default boilerplate code.
- [ ] **1.2 Setup Content Engine**: Install `gray-matter`. Create `src/lib/markdown.ts` to read timeline and project items.
- [ ] **1.3 Type Definitions**: Define `TimelineItem` and `Project` interfaces in `src/types`.
